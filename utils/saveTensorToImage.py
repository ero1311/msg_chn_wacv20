...
def saveTensorToImage(outputs, vars, labels, inputs_d, inputs_rgb, mae_map, item_idxs, save_to_path, epoch):
    ...
    for t in range(outputs.shape[0]):
        ...
        final_img.append(colorize_depth(mae_map[t], cmap_uncertainty))
